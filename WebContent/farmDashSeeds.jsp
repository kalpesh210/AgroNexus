...
<%@ page import ="java.sql.*"  %>
 <%@ page import="com.farm.*"%>
    ...
    System.out.println(crname);
	  ...
	  PreparedStatement stmt = con.prepareStatement("select * from seeds where scategory=?");
...
<div class="wrapper home2">
        ...
        <section class="testimonials-section wf100 p80" style="padding: 13px;">
            <h1 class="text-center" style="font-family : Raleway,sans-serif; font-weight:900;font-size: 28px;padding-top: 16px;">SEEDS PRODUCTS</h1>
	            ...
	            %>
	                <div class="col-md-4 col-sm-6 card">
                        ...
                        <div class="ser-box">
                           ...
                           <p class="pro-price" style="color: black;font-size: 22px;">&#x20b9  <%=rs.getInt("sprice") %><a style="font-size: 16px;margin-left: 25px;">Stock : <%=rs.getString("sstock") %></a></p>
                              <a href="buySeeds.jsp?id=<%= rs.getInt(1) %>"  style="color: #ffffff;"><button style="background-color: green;color: white;width: 201px;">Buy Now</button></a>
                        </div>
