...
<!DOCTYPE html PUBLIC "-//W3C//"WebContent/farmDash3.jsp"DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
.card:hover {
  transform: scale(1.1);
   ...
   <body>
    <%
    String crname=request.getParameter("data");
      ...
      <div class="wrapper home2">
        ...
        <section class="testimonials-section wf100 p80" style="padding: 13px;">
            <h1 class="text-center" style="font-family : Raleway,sans-serif; font-weight:900;font-size: 28px;padding-top: 16px;">FERTILIZERS AND SEEDS</h1>
            <h1 class="text-center" style="font-family : Raleway,sans-serif; font-weight:700;font-size: 20px;'">CROP SOLUTION</h1>
            </section>
         ...
         <section class="wf100 p80 blog">
            <div class="projects-grid">
               <div class="container">
                  <div class="row" style="margin-right: 250px;margin-left: 250px;    margin-top: -53px;">
                     
                     <div class="col-md-6 col-sm-6 card" style="margin-left: -60px;">
                        <!--campaign box start-->
                        <div class="ser-box">
                           <div class="ser-thumb">
                              <a href="farmDashSeeds.jsp?data=<%= crname %>"><i class="fas fa-link"></i></a>
                              <img src="images/seeds.jpg" alt="" style="width: 291px;height: 231px;">
                           </div>
                           <div class="ser-txt" style="padding: 14px 16px;">
                           <center>
                              <h5> <a href="farmDashSeeds.jsp?data=<%= crname %>">Seeds</a> 
                              </h5>
                              </center>
                           </div>
                        </div>
                     ...
                     <div class="col-md-6 col-sm-6 card"  style="margin-right: -60px;">
                        <!--campaign box start-->
                        <div class="ser-box">
                           <div class="ser-thumb">
                              <a href="farmDashFertilizers.jsp?data=<%= crname %>"><i class="fas fa-link"></i></a>
                              <img src="images/fertilizers.jpg" alt=""  style="width: 291px;height: 231px;">
                           </div>
                           <div class="ser-txt" style="padding: 14px 16px;">
                           <center>
                              <h5> <a href="farmDashFertilizers.jsp?data=<%= crname %>">Fertilizers</a> 
                              </h5>
                              </center>
                            </div>
                        </div>
