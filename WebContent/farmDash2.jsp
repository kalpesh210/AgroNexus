...
<div class="wrapper home2">
         ...
         <section id="home-slider" class="owl-carousel owl-theme wf100">
            <div class="item">
               <div class="slider-caption h2slider">
                  <div class="container">
                            <a style="margin: 310px 16px 0 0;background-color: #28f132;" href="farmDash1.jsp" class="active"  >All My Products</a> <a href="farmDash2.jsp">Buy Fertilizers and Seeds</a> 
        ...
        <section class="testimonials-section wf100 p80" style="padding: 13px;">
            <h1 class="text-center" style="font-family : Raleway,sans-serif; font-weight:900;font-size: 28px;padding-top: 16px;">Select Crop</h1>
               ...
               <div class="container">
	            ...
	            %>
                      ...
                      <div class="col-md-4 col-sm-6 card">
                        ...
                        <div class="ser-box">
                           <div class="ser-thumb">
                              <a href="farmDash3.jsp?data=<%=rs.getString(2) %>" ><i class="fas fa-link" style="line-height: 2;"></i></a>
                               <img src="data:image/png;base64,<%= base64Image %>"  alt="">
                           </div>
                           <div class="ser-txt" style="padding: 14px 16px;">
                           <center>
                              <h5> <a href="farmDash3.jsp?data=<%=rs.getString(2) %>" ><%=rs.getString("crname") %></a> </h5>
                              </center>
                            </div>
                        </div>
                        <!--campaign box end--> 
