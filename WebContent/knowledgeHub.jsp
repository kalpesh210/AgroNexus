...
<div class="wrapper home2">
         ...
         <!--Header End--> 
          <section class="testimonials-section wf100 p80" style="padding: 13px;">
            <h1 class="text-center" style="font-family : Raleway,sans-serif; font-weight:900;font-size: 28px;padding-top: 16px;">Select Crop For All Information</h1>
               ...
               <div class="container">
	            ...
	            %>
                      ...
                      <div class="col-md-4 col-sm-6 card">
                        ...
                        <div class="ser-box">
                           <div class="ser-thumb">
                              <a href="Knowledge.jsp?data=<%=rs.getString(2) %>" ><i class="fas fa-link" style="line-height: 2;"></i></a>
