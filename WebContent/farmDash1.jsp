...
<%@ page import ="java.sql.*"  %>
 <%@ page import="com.farm.*"%>
     ...
     <%
	  ...
	  PreparedStatement stmt = con.prepareStatement("select * from fruitsVegetables where fid=?");
	  int fid= Data.getFid();
	  stmt.setInt(1,fid);
...
<div class="wrapper home2">
        ...
        <!--Slider Start-->
         <section id="home-slider" class="owl-carousel owl-theme wf100">
            <div class="item">
               <div class="slider-caption h2slider"  style="top: 22%;">
                  <div class="container">
                                    <strong><span></span> Ways the  </strong>
                     <h1>TECHNOLOGY</h1>
                     <p>makes <strong> AGRICULTURE market </strong> smart</p>
                             <a href="farmDash1.jsp" class="active"  style="background-color: #28f132;">All My Products</a> <a href="farmDash2.jsp">Buy Fertilizers and Seeds</a> 
            ...
            <div class="item">
               <div class="slider-caption h2slider"  style="top: 22%;">
                  <div class="container">
                     <strong><span></span> Green Acres </strong>
                     <h1>Go Digital</h1>
                     <p>makes <strong> Welcome to E-Farm Life!</strong></p>
                       <a href="farmDash1.jsp" class="active" style="background-color: #28f132;">All My Products</a> <a href="farmDash2.jsp">Buy Fertilizers and Seeds</a> 
                     
                   </div>
               </div>
               <img src="images/farm5.jpg"  style="height: 487px"; alt=""> 
            </div>
	            ...
	            %>
	                <div class="col-md-4 col-sm-6 card">
                        ...
                        <div class="ser-box">
                           ...
                           <h6><a href="#" style="font-size: 22px;color: #000000;"> <%=rs.getString("fvname") %></a></h6>
                             <h6><a href="#" style=";font-size: 15px;color: #000000;">Category :<%=rs.getString("fvcategory") %></a></h6>
                           
                           <p class="pro-price" style="color: black;font-size: 22px;">&#x20b9  <%=rs.getInt("fvprice") %><span style="font-size: 11px;margin-left: 16px;">Stock : <%=rs.getString("fvstock") %></span><a href="updateFv.jsp?id=<%= rs.getInt(1) %>" style="color: black;font-size:11px"><button style="background-color: #4ed9ff;color: black;width: 51px;margin-left: 14px;">Update</button></a> </p>
                             <a href="deleteFv.jsp?id=<%= rs.getInt(1) %>" style="color: #ffffff;"> <button style="background-color: green;color: white;width: 201px;">Delete</button> </a>
                        </div>
