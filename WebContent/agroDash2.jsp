...
<%@ page import ="java.sql.*"  %>
 <%@ page import="com.farm.*"%>
     ...
     <%
	  ...
	  PreparedStatement stmt = con.prepareStatement("select * from fertilizers where aid=?");
	  int aid= Data.getAid();
	  stmt.setInt(1,aid);
        ...
        <!--Slider Start-->
         <section id="home-slider" class="owl-carousel owl-theme wf100">
            <div class="item">
               ...
               <img src="images/fertilizerback.jpg" alt=""> 
            </div>
            <div class="item">
               <div class="slider-caption h2slider">
                  <div class="container">
               ...
               <img src="images/seedsback.jpg" alt=""> 
            </div>
            ...
            <div class="projects-grid">
               <div class="container">
	            ...
	            { 
                    ...
                    Blob productImageBlob = rs.getBlob("ftimage");
	            ...
	            %>
	                <div class="col-md-4 col-sm-6 card">
                        ...
                        <div class="ser-box">
                           ...
                           <h6><a href="#" style="font-size: 22px;color: #000000;"> <%=rs.getString("ftname") %></a></h6>
                             <h6><a href="#" style=";font-size: 15px;color: #000000;">Category :<%=rs.getString("ftcategory") %></a></h6>
                           <h6 style="font-size: 12px;"><%= rs.getString("ftdescription") %></h6>
                           <p class="pro-price" style="color: black;font-size: 22px;">&#x20b9  <%=rs.getInt("ftprice") %><a style="font-size: 11px;margin-left: 16px;">Stock : <%=rs.getString("ftstock") %></a><button style="background-color: #4ed9ff;color: black;width: 51px;margin-left: 14px;"><a href="updateSeeds.jsp?id=<%= rs.getInt(1) %>" style="color: black;font-size:11px">Update</a></button> </p>
                              <button style="background-color: green;color: white;width: 201px;"><a href="deleteFertilizers.jsp?id=<%= rs.getInt(1) %>" style="color: #ffffff;">Delete</a></button> 
                        </div>
