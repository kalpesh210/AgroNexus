...
<%@ page import ="java.sql.*"  %>
 <%@ page import="com.farm.*"%>
     ...
     <%
	  ...
	  PreparedStatement stmt = con.prepareStatement("select * from fruitsvegetables");
...
<div class="wrapper home2">
        ...
        <!--Slider Start-->
         <section id="home-slider" class="owl-carousel owl-theme wf100">
            <div class="item">
             ...
             <p>   <strong style="color: #333;"><span style="color: #333;">Get the </span> Fresh Food</strong></p>
               <p>     <strong style="color: #333;"> <span style="color: #333;">From our </span>Agro Market</strong></p>
               <a href="about.html" class="active">About us</a> <a href="contact.html">Contact us</a> 
            ...
            <div class="item">
               <div class="slider-caption h2slider">
                  <div class="container">
                     ...
                     <p>"From Farm to Table, Excellence in Every Product. AgroNexus is Farmers' Pride, Consumers' Delight."</p>
                     <a href="about.html" class="active">About us</a> <a href="contact.html">Contact us</a> 
                   </div>
               </div>
         ...
         <!--Slider End--> 
          <section class="testimonials-section wf100 p80" style="padding: 13px;">
            <h1 class="text-center" style="font-family : Raleway,sans-serif; font-weight:900;font-size: 28px;padding-top: 16px;">FEATURED PRODUCTS</h1>
            <h1 class="text-center" style="font-family : Raleway,sans-serif; font-weight:700;font-size: 20px;'">FRUITS AND VEGETABLES</h1>
            </section>
	            ...
	            %>
	                <div class="col-md-4 col-sm-6 card">
                        ...
                        <div class="ser-box">
                           ...
                           <h6><a href="#" style="font-size: 25px;margin-left: 10px;color: #000000;"> <%=rs.getString("fvname") %></a></h6>
                             <h6 ><a href="#" class="funds" style=";font-size: 15px;margin-left: 10px;color: #000000;"><%=rs.getString("fvcategory") %></a></h6>
                         
                           <p class="pro-price" style="color: black;margin-left: 10px;font-size: 22px;">&#x20b9  <%=rs.getInt("fvprice") %></p>
                              <button style="background-color: green;color: white;width: 201px;"><a href="buyFruitsVegetables.jsp?id=<%= rs.getInt(1) %>" style="color: #ffffff;">Buy Now</a></button> 
                        </div>
		...
		<section>
           <div class="container">
        <h2 class="text text-center" style="font-weight:800;
    text-align: center!important;font-size: 4rem;font-family: cursive;"> 
