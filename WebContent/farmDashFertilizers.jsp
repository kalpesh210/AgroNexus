...
<%@ page import ="java.sql.*"  %>
 <%@ page import="com.farm.*"%>
     ...
     <%
	  ...
	  PreparedStatement stmt = con.prepareStatement("select * from fertilizers where ftcategory=?");
	            ...
	            %>
	                <div class="col-md-4 col-sm-6 card">
                        ...
                        <div class="ser-box">
                           ...
                           <p class="pro-price" style="color: black;font-size: 22px;">&#x20b9  <%=rs.getInt("ftprice") %><a style="font-size: 16px;margin-left: 25px;">Stock : <%=rs.getString("ftstock") %></a></p>
                             <a href="buyFertilizers.jsp?id=<%= rs.getInt(1) %>" style="color: #ffffff;"> <button style="background-color: green;color: white;width: 201px;">Buy Now</button></a>
                        </div>
