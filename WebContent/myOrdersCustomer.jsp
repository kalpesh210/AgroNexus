...
padding: 4px;
 ...
 <%@ page import="com.farm.*"%>
     ...
     int id = Data.getCid();
	  ...
	  PreparedStatement stmt = con.prepareStatement("select * from customerorder where cid=?");
	  stmt.setInt(1,id);
    ...
    <div>
	            ...
	            %>
			        <tr>
			            ...
			            <td><%=rs.getString("fvname")%></td>
			            <td><%=rs.getInt("fvprice")%></td>
			            <td><%=rs.getInt("quantity")%></td>
			            <td><%=rs.getString("address")%></td>
			            <td><%=rs.getString("fvcategory")%></td>
			            <td><%=rs.getInt("total")%></td>
		        
			             <td><a href="cancelOrder.jsp?oid=<%=rs.getInt(1)%>&cid=<%=rs.getInt("cid")%>">Cancel</a></td>
			        </tr>
