...
@media (min-width: 768px) {
   ...
   <body>
     <%
	  ...
	  PreparedStatement stmt = con.prepareStatement("select * from seeds where sid=?");
	  stmt.setInt(1, id);
    ...
    <div class="wrapper home2">
      ...
      int pprice=rs.getInt("sprice");
      int aid=rs.getInt("aid");
      String pname=rs.getString("sname") ;
      String ptype="Seeds" ;
      String pcategory=rs.getString("scategory") ;
      ...
      %>
						...
						<p>	    <label style="padding-top: 22px;" name="pname" for="product_name">Product Name : <%=rs.getString("sname") %> </label></p>
							  <input type="hidden" name="pname" value="<%=pname %>">
						  <input type="hidden" name="pid" value="<%=pid %>">
						   <input type="hidden" name="aid" value="<%=aid %>">
							<p>		<label for="product_name" name="pprice" oninput="calculateTotal()" >Price : <%=rs.getInt("sprice") %></label></p>
