...
padding: 4px;
 ...
 <%@ page import="com.farm.*"%>
     ...
     int id = Data.getFid();
	  ...
	  PreparedStatement stmt = con.prepareStatement("select * from farmerorder where fid=? and ptype=?");
	  stmt.setInt(1,id);
	  stmt.setString(2,"Seeds");
	            ...
	            %>
			        <tr>
			            ...
			            <td><%=rs.getInt("total")%></td>
			             ...
			             <td><a href="cancelOrderF.jsp?oid=<%=rs.getInt(1)%>&fid=<%=rs.getInt("fid")%>">Cancel</a></td>
			        </tr>
